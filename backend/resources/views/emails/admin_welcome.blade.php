...
<title>Accès Administrateur — ISI SUPTECH</title>
<style>
  ...
  .cred-value { font-size: 16px; font-weight: 700; color: #0f172a; font-family: 'Courier New', monospace; letter-spacing: 0.02em; }
...
<div class="wrapper">
  <div class="card">
    ...
    <div class="header">
      ...
      <div class="header-tag">Accès Administrateur</div>
    </div>

    <div class="body">
      <div class="greeting">Bienvenue, {{ $name }}</div>
      <p class="text">
        Un compte administrateur a été créé pour vous sur la
        <strong>Plateforme d'Évaluation ISI SUPTECH</strong>.
        Vous disposez d'un accès complet à la gestion de la plateforme.
      </p>
      ...
      <div class="notice">
        <strong>Important :</strong> Modifiez votre mot de passe dès votre première connexion depuis les paramètres de votre profil.
      </div>
